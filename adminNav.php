<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <a class="navbar-brand" href="adminHome.php"><img src="assets/img/logov6.png" alt="Logo" width="32" height="32" style="border-radius: 50%;">&nbsp; InTrade Business</a>
        ...
        <div class="collapse navbar-collapse row" id="navbarTogglerDemo02" style="z-index:10;">    
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="adminPage_dashboard.php">Dashboard</a>
                </li>
				<li class="nav-item">
